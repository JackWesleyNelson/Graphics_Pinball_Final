...
TARGET = Pinball
OBJECTS = main.o src/Object.o src/Material.o src/Ball.o src/Point.o src/Vector.o src/PointBase.o src/Camera.o src/CircularBoardObject.o src/RectangularBoardObject.o
